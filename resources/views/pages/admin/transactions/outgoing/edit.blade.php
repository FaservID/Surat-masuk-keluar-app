    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="container py-4">
                <form action="{{route("admin.outgoingTransactionUpdate", $letter->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-12">
                        <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="mt-4 mb-2">
                            <a href="{{route('admin.outgoingTransactionIndex')}}" class="btn btn-primary">Kembali</a>
