    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="container py-4">
                ...
                <a href="{{route('admin.outgoingTransactionIndex')}}" class="btn btn-primary my-2">Kembali</a>
                @else
                <a href="{{route('kabid.outgoingAgendaIndex')}}" class="btn btn-primary my-2">Kembali</a>
                @endif
