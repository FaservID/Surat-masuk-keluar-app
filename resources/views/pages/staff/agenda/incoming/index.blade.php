...
<div class="col-12">
    <div class="card mb-4">
        <div class="container py-4">
            ...
            <div class="col-12">
                <form action="{{route('staff.incomingAgendaSearchDate')}}" method="GET">
                    {{-- @method('GET') --}}
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div>
                                ...
                                <button formtarget="_blank" formaction="{{route('staff.incomingAgendaExport')}}" class="btn btn-primary">Cetak</button>
                            </div>
                        </div>
                    </div>
                </form>
