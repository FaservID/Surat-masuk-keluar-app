...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Buku Agenda /</span> Surat Keluar</h4>
</div>
...
<div class="col-12">
    <div class="card mb-4">
        <div class="container py-4">
            ...
            <div class="col-12">
                <form action="{{route('staff.outgoingAgendaSearchDate')}}" method="GET">
                    {{-- @method('GET') --}}
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div>
                                ...
                                <button formtarget="_blank" formaction="{{route('staff.outgoingAgendaExport')}}" class="btn btn-primary">Cetak</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('staff.incomingTransactionDetail', $letter->id)}}">{{$letter->reference_number}}</a></td>
                            <td>{{$letter->to}}</td>
