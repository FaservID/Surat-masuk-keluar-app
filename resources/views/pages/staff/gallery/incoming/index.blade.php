...
@section('title', 'Gallery Surat Masuk')
...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Galeri Surat /</span> Surat Masuk</h4>
</div>
                ...
                <div class="container py-3">
                    <div class="col-md-12 d-flex">
                        <div class="col-md-8">
                            ...
                            <div><a href="{{route('staff.incomingTransactionDetail', $letter->id)}}">{{$letter->reference_number}}</a></div>
