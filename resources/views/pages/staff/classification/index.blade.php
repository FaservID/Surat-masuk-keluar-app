...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    ...
    <div class="py-3">
        <a href="{{route('staff.classificationCreate')}}" class="btn btn-primary float-right">Tambah Baru</a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-start">
                                <div>
                                    <a href="{{route('staff.classificationEdit', $classification->code)}}" class="btn btn-sm btn-warning">Edit</a>
                                </div>
                                |
                                <div>
                                    <form method="POST" action="{{route('staff.classificationDestroy', $classification->code)}}">
                                        @csrf
