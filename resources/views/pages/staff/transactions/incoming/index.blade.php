...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi Surat /</span> Surat Masuk</h4>
    <div class="py-3">
        <a href="{{route('staff.incomingTransactionCreate')}}" class="btn btn-primary float-right">Tambah Baru</a>
    </div>
</div>
                ...
                <div class="d-flex justify-content-between gap-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{route('staff.incomingTransactionEdit', $letter->id)}}">Edit</a></li>
                            <li><a class="dropdown-item" href="{{route('staff.incomingTransactionDetail', $letter->id)}}">Lihat Detail</a></li>
                            <li>
                                <form method="POST" action="{{route('staff.incomingTransactionDestroy', $letter->id)}}">
                                    @csrf
