...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi Surat / Surat Keluar /</span> Detail</h4>
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="container py-4">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="{{route('staff.incomingTransactionDetail', $letter->id)}}">Detail</a></li>
                                <li>
                ...
                <a href="{{route('staff.outgoingTransactionIndex')}}" class="btn btn-primary my-2">Kembali</a>
