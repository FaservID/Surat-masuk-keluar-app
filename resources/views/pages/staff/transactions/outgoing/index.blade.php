...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    ...
    <div class="py-3">
        <a href="{{route('staff.outgoingTransactionCreate')}}" class="btn btn-primary float-right">Tambah Baru</a>
    </div>
</div>
                ...
                <div class="d-flex justify-content-between gap-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{route('staff.outgoingTransactionEdit', $letter->id)}}">Edit</a></li>
                            <li><a class="dropdown-item" href="{{route('staff.outgoingTransactionDetail', $letter->id)}}">Lihat Detail</a></li>
                            <li>
                                <form method="POST" action="{{route('staff.outgoingTransactionDestroy', $letter->id)}}">
                                    @csrf
