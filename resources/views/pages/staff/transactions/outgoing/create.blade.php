...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi Surat / Surat Keluar /</span> Tambah Baru</h4>
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="container py-4">
                <form action="{{route("staff.outgoingTransactionStore")}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" value="{{ old('to') }}" class="form-control @error('to') is-invalid @enderror" name="to" id="from" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('to')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
