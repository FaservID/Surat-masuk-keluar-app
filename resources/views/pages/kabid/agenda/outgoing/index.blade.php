...
<div class="col-12">
    <div class="card mb-4">
        <div class="container py-4">
            ...
            <div class="col-12">
                <form action="{{route('kabid.outgoingAgendaSearchDate')}}" method="GET">
                    {{-- @method('GET') --}}
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div>
                                ...
                                <button formtarget="_blank" formaction="{{route('kabid.outgoingAgendaExport')}}"  class="btn btn-primary">Cetak</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('kabid.outgoingTransactionDetail', $letter->id)}}">{{$letter->reference_number}}</a></td>
                            <td>{{$letter->to}}</td>
